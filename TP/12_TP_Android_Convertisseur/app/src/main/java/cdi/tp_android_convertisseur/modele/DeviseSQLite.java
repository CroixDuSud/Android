...
public class DeviseSQLite extends SQLiteOpenHelper {
    ...
    public static final String INSERT_LIVRE =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Livre',0.6405);";
    public static final String INSERT_EURO =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Euro',0.7697);";
    public static final String INSERT_DIRHAM =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Dirham',8.5656);";
    public static final String INSERT_YEN =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Yen',76.6908);";
    public static final String INSERT_FRANC_CFA =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Franc CFA',503.17);";
    public static final String INSERT_DOLLARS_US =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Dollar US',1);";
    public static final String INSERT_FRANC =
            "INSERT INTO " + DeviseDAO.TABLE_DEVISES + " (monnaie, taux) VALUES ('SQLite Franc',5.049);";
