...
import cdi.tp_android_convertisseur.modele.DeviseREST;
...
public class MainActivity extends AppCompatActivity {
    ...
    // adresse ip du serveur REST Afpa Creteil PTAL
    private static final String	URL_SERVEUR = "http://10.75.96.104:81/webserv/selDevises.php";
    // adresse ip du serveur wamp local à partir de l'émulateur Android
    //private static final String	URL_SERVEUR = "http://10.0.2.2:8080/webserv/selDevises.php";
    // query string de requête permettant l'obtention de toutes les devises
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            // recuperation des devises à partir du serveur REST
            DeviseREST tacheAsynchrone;

            tacheAsynchrone = new DeviseREST(MainActivity.this, this);
            tacheAsynchrone.execute(URL_SERVEUR, REQ_PARAM);
        } else {
            // récupération des devises à partir SQlite
            toast("Pas d'accès internet : utilisation des taux en base !");
            devises = Convert.getDevisesSQlite(this);
        }
    ...
    public String getStrDevDep() { return devDep; }

    public String getStrDevArr() { return devArr; }
     ...
     */
    public void chargeSpinner(int idView, String devDefaut) {
